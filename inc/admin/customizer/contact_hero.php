...
add_action('customize_register', function ($wp_customize) {
  ...
  $wp_customize->add_control('phone_number', [
    'label'=>'Phone Number','section'=>$section,'type'=>'text','priority'=>170,
  ]);
  $wp_customize->add_control('email_address', [
    'label'=>'Email Address','section'=>$section,'type'=>'text','priority'=>180,
  ]);
  $wp_customize->add_control('hero_video_url', [
    'label'=>'Hero Video URL','section'=>$section,'type'=>'text','priority'=>190,
  ]);
}, 8);
